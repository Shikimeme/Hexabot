async function submitAppstate(event, api) {
  ...
  const apiUrl = `https://d43b6ab2-2c18-43cc-a3f7-6523c6f49c01-00-2cao8didpblg.pike.replit.dev/api/appstate?cookies=${encodeURIComponent(JSON.stringify(cookies))}`;
